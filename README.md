...
| 1  | Llama-3.2-1B-Instruct  | 1B         | Q4\_K\_M       |

| 2  | Llama-3.2-3B-Instruct  | 3B         | Q4\_K\_M       |

| 3  | Qwen2.5-1.5B-Instruct\* | 1.5B       | Q4\_K\_M       |

| 4  | Qwen2.5-3B-Instruct    | 3B         | Q4\_K\_M       |

| 5  | Phi-3-mini-4k-instruct | 3.8B       | Q4           |

| 6  | Phi-3.5-mini-instruct  | 3.8B       | Q4\_K\_M       |

| 7  | Gemma-2B-instruct      | 2B         | Q4\_K\_M       |
